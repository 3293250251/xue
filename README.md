     ...
     <!-- 头部区域 -->
      <div class="toubu">
        <div class="banxin">
            ...
            <div class="daohang">
                <ul>
                    <li><a href="#" class="moreng">首页</a></li>
                    <li><a href="#">课程</a></li>
                    <li><a href="#">职业规划</a></li>
                </ul>
            </div>
        ...
        <div class="banxin">
            ...
            <div class="you">
                ...
                <div class="neirong">
                    ...
                    <dl>
                        <dt>React核心技术课程</dt>
                            <dd><span>正在学习</span>-<strong>react配合TS使用</strong></dd>
                    </dl>
                    <a href="#">全部课程</a>
                </div>
            </div>
      ...
      <div class="tuijian banxin">
        ...
        <ul>
            ...
            <li><a href="#">Ajax</a></li>
            <li><a href="#">Vuo2.0</a></li>
            <li><a href="#">Vou3.0</a></li>
      ...
      <div class="banxin">
        ...
        <div class="bd">
            <div class="zuo">
                <img src="./学成在线素材-图片/uploads/web_left.png" alt="">
            </div>
            <div class="you">
                <div class="shang">
                    <img src="./学成在线素材-图片/uploads/web_top.png" alt="">
                </div>
                <div class="xia">
                    <ul>
                        <li>
        ...
        <div class="bd">
            <div class="zuo">
                <img src="./学成在线素材-图片/uploads/python_left.png" alt="">
            </div>
            <div class="you">
                <div class="shang">
                    <img src="./学成在线素材-图片/uploads/python_top.png" alt="">
                </div>
                <div class="xia">
                    <ul>
                        <li>
      ...
      <div class="kecheng banxin">
        ...
        <div class="bd ban">
            <ul>
                ...
                <li>
                    <a href="#">
                        <div class="pic"><img src="./学成在线素材-图片/uploads/java05.png" alt=""></div>
                        <div class="text">
